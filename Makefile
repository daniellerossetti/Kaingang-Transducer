...
pkgdatadir = $(datadir)/apertium-kgp
pkgincludedir = $(includedir)/apertium-kgp
pkglibdir = $(libdir)/apertium-kgp
pkglibexecdir = $(libexecdir)/apertium-kgp
...
CONFIG_CLEAN_FILES = apertium-kgp.pc
...
am__installdirs = "$(DESTDIR)$(apertium_kgpdir)" \
	"$(DESTDIR)$(pkgconfigdir)"
DATA = $(apertium_kgp_DATA) $(noinst_DATA) $(pkgconfig_DATA)
am__tagged_files = $(HEADERS) $(SOURCES) $(TAGS_FILES) $(LISP)
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/apertium-kgp.pc.in \
...
ACLOCAL = ${SHELL} /home/drosset1/ling073/ling073-kgp/missing aclocal-1.15
AMTAR = $${TAR-tar}
...
AUTOCONF = ${SHELL} /home/drosset1/ling073/ling073-kgp/missing autoconf
AUTOHEADER = ${SHELL} /home/drosset1/ling073/ling073-kgp/missing autoheader
AUTOMAKE = ${SHELL} /home/drosset1/ling073/ling073-kgp/missing automake-1.15
AWK = gawk
CGCOMP = /usr/bin/cg-comp
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Apertium\ kgp\" -DPACKAGE_TARNAME=\"apertium-kgp\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"Apertium\ kgp\ 0.1.0\" -DPACKAGE_BUGREPORT=\"drosset1@cs.swarthmore.edu\" -DPACKAGE_URL=\"http://wiki.apertium.org/wiki/Apertium-kgp\" -DPACKAGE=\"apertium-kgp\" -DVERSION=\"0.1.0\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/drosset1/ling073/ling073-kgp/missing makeinfo
MKDIR_P = /bin/mkdir -p
PACKAGE = apertium-kgp
PACKAGE_BUGREPORT = drosset1@cs.swarthmore.edu
PACKAGE_NAME = Apertium kgp
PACKAGE_STRING = Apertium kgp 0.1.0
PACKAGE_TARNAME = apertium-kgp
PACKAGE_URL = http://wiki.apertium.org/wiki/Apertium-kgp
...
STRIP = 
VERSION = 0.1.0
abs_builddir = /home/drosset1/ling073/ling073-kgp
abs_srcdir = /home/drosset1/ling073/ling073-kgp
abs_top_builddir = /home/drosset1/ling073/ling073-kgp
abs_top_srcdir = /home/drosset1/ling073/ling073-kgp
am__leading_dot = .
...
install_sh = ${SHELL} /home/drosset1/ling073/ling073-kgp/install-sh
...
###############################################################################
#
#   apertium_kgp_dir: This is where the compiled binaries go
#   apertium_kgp_srcdir: This is where the source files go
apertium_kgpdir = $(prefix)/share/apertium/$(BASENAME)/
apertium_kgp_srcdir = $(prefix)/share/apertium/$(BASENAME)/
EXTRA_TARGETS = $(am__append_1)
apertium_kgp_DATA = $(TARGETS_COMMON) $(EXTRA_TARGETS)
...
$(am__aclocal_m4_deps):
apertium-kgp.pc: $(top_builddir)/config.status $(srcdir)/apertium-kgp.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
install-apertium_kgpDATA: $(apertium_kgp_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_kgp_DATA)'; test -n "$(apertium_kgpdir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_kgpdir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_kgpdir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_kgpdir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_kgpdir)" || exit $$?; \
	done

uninstall-apertium_kgpDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_kgp_DATA)'; test -n "$(apertium_kgpdir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_kgpdir)'; $(am__uninstall_files_from_dir)
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_kgpdir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
install-data-am: install-apertium_kgpDATA install-data-local \
...
uninstall-am: uninstall-apertium_kgpDATA uninstall-pkgconfigDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-apertium_kgpDATA install-data \
	...
	uninstall-am uninstall-apertium_kgpDATA \
	uninstall-pkgconfigDATA
...
install-data-local: install-modes
	test -d $(DESTDIR)$(apertium_kgp_srcdir) || mkdir -p $(DESTDIR)$(apertium_kgp_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).lexc $(DESTDIR)$(apertium_kgp_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).twol $(DESTDIR)$(apertium_kgp_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).rlx $(DESTDIR)$(apertium_kgp_srcdir)
	$(INSTALL_DATA) $(BASENAME).post-$(LANG1).dix $(DESTDIR)$(apertium_kgp_srcdir)
clean-local:
	-rm -rf .deps modes
...
test: all
	echo "TODO test sentence" | apertium -d . kgp-morph | tee .test-mt
